...
namespace ToDoApp.Controllers
{
    ...
    public class ToDoesController : Controller
    {
        ...
        public ActionResult CustIndex([Bind(Include = "Id,Description,DueDate,IsComplete")] ToDo toDo)
        {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,DueDate,IsComplete")] ToDo toDo)
        {
            if (ModelState.IsValid)
            {
                string currentUserId = User.Identity.GetUserId();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,DueDate,IsComplete")] ToDo toDo)
        {
            if (ModelState.IsValid)
            {
                db.Entry(toDo).State = EntityState.Modified;
